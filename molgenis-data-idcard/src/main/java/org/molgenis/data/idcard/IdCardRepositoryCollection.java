...
abstract public class IdCardRepositoryCollection<E extends IdCardEntity> implements ManageableRepositoryCollection {

    public static final String BASE_NAME = "ID-Card ";
    private final DataService dataService;
    private final IdCardRepository<E> idCardBiobankRepository;
    private final Map<String, Repository> repositories;

    abstract protected String getEntityName();

    protected IdCardRepositoryCollection(DataService dataService, IdCardRepository<E> idCardBiobankRepository) {
    ...
    public Repository addEntityMeta(EntityMetaData entityMeta) {
        ...
        } else if (repositories.containsKey(getEntityName())) {
            throw new MolgenisDataException(
                    "ID-Card repository collection already contains repository [" + entityName + "]");
        } else {
            repositories.put(getEntityName(), idCardBiobankRepository);
        }
