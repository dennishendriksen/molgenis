package org.molgenis.api.entities.v1;
...
import static org.molgenis.api.entities.v1.RestController.BASE_URI;
...
import org.molgenis.api.entities.RestService;
import org.molgenis.api.entities.ServletUriComponentsBuilderFactory;
import org.molgenis.api.entities.v1.RestControllerTest.RestControllerConfig;
...
public class RestControllerTest extends AbstractTestNGSpringContextTests {
  ...
  private static final String ENTITY_COLLECTION_RESPONSE_STRING =
      "{\"href\":\""
          + HREF_ENTITY
          + "\",\"meta\":{\"href\":\"/api/v1/Person/meta\",\"hrefCollection\":\"/api/v1/Person\",\"name\":\"Person\",\"attributes\":{\"name\":{\"href\":\"/api/v1/Person/meta/name\"},\"id\":{\"href\":\"/api/v1/Person/meta/id\"},\"enum\":{\"href\":\"/api/v1/Person/meta/enum\"},\"int\":{\"href\":\"/api/v1/Person/meta/int\"}},\"idAttribute\":\"id\",\"isAbstract\":false,\"languageCode\":\"en\",\"permissions\":[],\"writable\":false},\"start\":5,\"num\":10,\"total\":0,\"prevHref\":\""
          + HREF_ENTITY
  ...
  private static final String ENTITY_META_RESPONSE_STRING =
      "{\"href\":\""
          ...
          + HREF_ENTITY_META
          + "/name\"},\"id\":{\"href\":\"/api/v1/Person/meta/id\"},\"enum\":{\"href\":\"/api/v1/Person/meta/enum\"},\"int\":{\"href\":\"/api/v1/Person/meta/int\"}},\"idAttribute\":\"id\",\"isAbstract\":false,\"languageCode\":\"en\",\"permissions\":[],\"writable\":false}";
  ...
  public void testLogoutTokenInHeader() throws Exception {
    mockMvc
        .perform(
            post(BASE_URI + "/logout").header(TokenExtractor.TOKEN_HEADER, "abcde").content(""))
  ...
  public void testLogoutTokenInParam() throws Exception {
    mockMvc
        .perform(
            post(BASE_URI + "/logout").param(TokenExtractor.TOKEN_PARAMETER, "abcde").content(""))
        .andExpect(status().isOk());
    verify(tokenService).removeToken("abcde");
  }
  ...
  public void testLogoutNoToken() throws Exception {
    mockMvc
        .perform(post(BASE_URI + "/logout").content(""))
  ...
  public void retrieveEntityTypeWritable() throws Exception {
    when(permissionService.hasPermission(
            new EntityTypeIdentity(ENTITY_NAME), EntityTypePermission.UPDATE_DATA))
        .thenReturn(true);
            ...
            content()
                .json(
                    "{\"href\":\""
                        ...
                        + "\",\"attributes\":{\"name\":{\"href\":\""
                        + HREF_ENTITY_META
                        + "/name\"},\"id\":{\"href\":\"/api/v1/Person/meta/id\"},\"enum\":{\"href\":\"/api/v1/Person/meta/enum\"},\"int\":{\"href\":\"/api/v1/Person/meta/int\"}},\"idAttribute\":\"id\",\"isAbstract\":false,\"languageCode\":\"en\",\"permissions\":[],\"writable\":true}"));
  }

  @Test
  public void retrieveEntityTypeNotWritable() throws Exception {
    when(permissionService.hasPermission(
            new EntityTypeIdentity(ENTITY_NAME), EntityTypePermission.ADD_DATA))
        .thenReturn(true);
    when(dataService.getCapabilities(ENTITY_NAME))
            ...
            content()
                .json(
                    "{\"href\":\""
                        ...
                        + "\",\"hrefCollection\":\"/api/v1/Person\",\"name\":\""
                        + ENTITY_NAME
                        + "\",\"languageCode\":\"en\",\"permissions\":[],\"writable\":false}"));
  }
  ...
  public void retrieveEntityAttributeUnknownAttribute() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                FIRST_ERROR_MESSAGE, is("Unknown attribute 'name' of entity type 'My Entity'.")));
  }
  ...
  public void retrieveEntityAttributeUnknownEntity() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                FIRST_ERROR_MESSAGE,
                is("Unknown attribute 'name' of entity type 'My entity type'.")));
  }
