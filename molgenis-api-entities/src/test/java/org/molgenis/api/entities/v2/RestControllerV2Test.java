...
import static org.molgenis.api.entities.v2.RestControllerV2.BASE_URI;
...
import org.molgenis.api.entities.v2.RestControllerV2Test.RestControllerV2Config;
  ...
  public void testCopyEntityDuplicateEntity() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                FIRST_ERROR_MESSAGE,
                is("Opslagplaats 'org_molgenis_blah_duplicateEntity' bestaat al.")));
    verifyZeroInteractions(repoCopier);
  }
