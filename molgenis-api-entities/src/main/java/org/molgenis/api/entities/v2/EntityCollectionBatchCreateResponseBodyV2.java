...
public class EntityCollectionBatchCreateResponseBodyV2 {
  /**
   * The location is not added to location response header because it can become too large. The
   * Location will contains a href to the collection that is created.
   */
