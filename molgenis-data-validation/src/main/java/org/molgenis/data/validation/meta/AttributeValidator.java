...
public class AttributeValidator {
  ...
  static {
    ...
    // transitions to CATEGORICAL_MREF and MREF not allowed because junction tables updated not
    // implemented
    // transitions to FILE not allowed because associated file in FileStore not created/removed, see
    // github issue https://github.com/molgenis/molgenis/issues/3217
