...
import { faCheckCircle, faFolderOpen, faFileCode, faHourglass, faTimesCircle } from '@fortawesome/free-regular-svg-icons'
...
library.add(faCheckCircle, faClone, faCut, faEdit, faDownload, faFileCode, faFolderOpen, faHome, faHourglass, faList, faPaste, faPlus, faSearch, faTimes, faTimesCircle, faTrash, faUpload)
