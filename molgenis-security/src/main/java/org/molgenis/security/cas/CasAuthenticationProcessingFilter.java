package org.molgenis.security.cas;
...
public class CasAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter
{
	private static final Logger LOG = LoggerFactory.getLogger(CasAuthenticationProcessingFilter.class);
	...
	@Autowired
	public CasAuthenticationProcessingFilter(GooglePublicKeysManager googlePublicKeysManager,
